...
- **Next up (2026-09-06) -- read this first if you are the next session.** **All feature work in
  ...
  **Order:** T-508 is done. Next T-509 and T-510 alongside each other, and T-515 in its own session
  whenever the owner wants it; it blocks the version, not the phase milestone.
