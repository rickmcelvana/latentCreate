...
**T-403 (album lists, the second milestone line) is briefed** -- split three ways
([a](tasks/t-403a-brief.md) backend, [b](tasks/t-403b-brief.md) frontend store, [c](tasks/t-403c-brief.md)
Library panel) for the ~400-line rule. T-404 … T-406 planned, not briefed.
