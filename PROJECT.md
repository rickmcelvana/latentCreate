...
- **OQ-8 (2026-08-28): what should an empty text field send?** Found by the first ACE-Step run
  ...
  Recommend 1, with 2 as the eventual shape once the panel already reads a template for other
  reasons. Not chosen unilaterally because it changes what every generation sends.
