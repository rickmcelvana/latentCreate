...
**Progress:** T-201 … T-209 landed (project/lyric store, brief + prompt assembly, the structure-tag lint, `reasoning_effort`, the streaming command, the frontend bridge/store, the brief form, the generation UI, and the versioned editor with lint + approve). T-210 (prompt optimizer) and T-211 (live milestone) remain.
