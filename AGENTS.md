...
5. `tasks/ROADMAP.md` → the current `tasks/phase-N.md` — pick up the first unfinished T-number. **Currently [tasks/phase-1.md](tasks/phase-1.md)**; T-101 through T-111e have landed and **T-112a-d (Setup wizard: LLM step) is next**. PROJECT.md's Snapshot carries the live state — trust it over this line if they ever disagree.
